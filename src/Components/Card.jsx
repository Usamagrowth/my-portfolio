 ...
 setFullImage(!fullImage) };
  ...
  return (
    <div className="p-3 shadow-sm rounded-lg bg-[#004600] items-center">
     ...
     <div> 
      {fullImage ? <div className="border border-white rounded-lg w-[350px] h-[200px] overflow-hidden object-cover">
    ...
    <p onClick={view} className="text-[#44e944] font-semibold cursor-pointer">{fullimage}</p>
