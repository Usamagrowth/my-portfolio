...
const Footer = () => {
  return (
    <div className="flex gap-8 px-10 py-5 bg-[#004600] flex-col lg:flex-row lg:justify-between lg:items-center">
    <div className="flex flex-col gap-2">
     <h3 className="text-2xl font-bold text-white">Usama Growth Solutions</h3>
